    	...
    	while(!open.isEmpty() && cost.get(goal) > open.peek().getExpectValue()){
    		...
    		for(State succ : successors){
    			...
    			if(cost.get(succ) > cost.get(s) + PACECOST){
    				...
    				//System.out.println("cost of succ:"+cost.get(succ)+",cost of s:"+cost.get(s));
    				//System.out.println();
    			}
    			//System.out.println("cordinate of succ:("+succ.getRow()+","+succ.getCol()+")"
    			//		+" cordinate of s:"+s.getRow()+","+s.getCol()+")");
    			//System.out.println("cost of succ:"+cost.get(succ)+",cost of s:"+cost.get(s));
    			//System.out.println("manhattan dis succ:"+succ.getExpectValue());
    		}
